...
Class Theme_Post_Tab extends WP_Widget {
	public function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__( 'Post Tab Display Widget' , 'neuzin-core' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'rt-post-tab', esc_html__( 'Neuzin : Posts display Tab' , 'neuzin-core' ), $widget_ops );
	}
	public function widget( $args, $instance ) {
		...
		<div class="post-tab-layout">
			<ul class="btn-tab item-inline2 block-xs nav nav-tabs" role="tablist">
				<li class="nav-item">
					<a href="#recent-<?php esc_html_e( $tab_id ); ?>" data-toggle="tab" aria-expanded="true" class="active"><?php esc_html_e('Recent', 'neuzin-core'); ?></a>
				</li>
				<li class="nav-item">
					<a href="#popular-<?php esc_html_e( $tab_id ); ?>" data-toggle="tab" aria-expanded="false"><?php esc_html_e( 'Popular', 'neuzin-core'); ?></a>
				</li>
				<li class="nav-item">
					<a href="#common-<?php esc_html_e( $tab_id ); ?>" data-toggle="tab" aria-expanded="false"><?php esc_html_e( 'Comment', 'neuzin-core'); ?></a>
				</li>
			</ul>
