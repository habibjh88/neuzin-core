...
$post_types = [
	'neuzin_team'      => [
		...
		'rewrite'         => NeuzinTheme::neuzin_options( 'team_slug' ),
	...
	'neuzin_service'   => [
		...
		'rewrite'      => NeuzinTheme::neuzin_options( 'service_slug' ),
		'supports'     => [ 'title', 'thumbnail', 'editor', 'excerpt', 'page-attributes' ],
	],
	'neuzin_portfolio' => [
		...
		'menu_icon'    => 'dashicons-book',
		'rewrite'      => NeuzinTheme::neuzin_options( 'portfolio_slug' ),
		'supports'     => [ 'title', 'thumbnail', 'editor', 'excerpt', 'page-attributes' ],
		'taxonomies'   => [ 'post_tag' ],
	],
	'neuzin_testim'    => [
		...
		'rewrite'      => NeuzinTheme::neuzin_options( 'testimonial_slug' ),
...
$taxonomies = [
	'neuzin_team_category'        => [
		...
		'rewrite'      => [ 'slug' => NeuzinTheme::neuzin_options( 'team_cat_slug' ) ],
	],
	'neuzin_service_category'     => [
		...
		'rewrite'      => [ 'slug' => NeuzinTheme::neuzin_options( 'service_cat_slug' ) ],
	],
	'neuzin_portfolio_category'   => [
		...
		'rewrite'      => [ 'slug' => NeuzinTheme::neuzin_options( 'portfolio_cat_slug' ) ],
	],
	'neuzin_testimonial_category' => [
		...
		'rewrite'      => [ 'slug' => NeuzinTheme::neuzin_options( 'testim_cat_slug' ) ],
	],
];
