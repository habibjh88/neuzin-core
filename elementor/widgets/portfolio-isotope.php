...
class Portfolio_Isotope extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Portfolio Isotope', 'neuzin-core' );
	...
	public function rt_fields(){
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'layout1' => esc_html__( 'Isotope layout 1', 'neuzin-core' ),
					'layout2' => esc_html__( 'Isotope layout 2', 'neuzin-core' ),
					'layout3' => esc_html__( 'Isotope layout 3', 'neuzin-core' ),
					'layout4' => esc_html__( 'Isotope layout 4', 'neuzin-core' ),
				),
				'default' => 'layout1',
			),			
