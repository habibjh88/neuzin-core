...
class Logo_Slider extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Logo Slider and Grid', 'neuzin-core' );
	...
	public function rt_fields(){
		...
		$repeater->add_control(
            ...
            array(
                ...
                'label' => esc_html__( 'URL(optional)', 'neuzin-core' ),
                'label_block' => true,
			)
        );
		...
		$fields = array(
			...
			array(
				...
				'id'      => 'layout',
				'label'   => esc_html__( 'Logo Layout', 'neuzin-core' ),
				'options' => array(
					'layout1' => esc_html__( 'Logo Slider', 'neuzin-core' ),
					'layout2' => esc_html__( 'Logo Grid', 'neuzin-core' ),
				),
				'default' => 'layout1',
			),
			array(
			...
			array(
				...
				'id'      => 'logos',
				'label'   => esc_html__( 'Add as many logos as you want', 'neuzin-core' ),
