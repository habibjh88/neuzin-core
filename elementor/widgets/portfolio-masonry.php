...
class Portfolio_Masonry extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Portfolio Masonry', 'neuzin-core' );
	...
	public function rt_fields(){
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'layout1' => esc_html__( 'Masonry layout 1', 'neuzin-core' ),
					'layout2' => esc_html__( 'Masonry layout 2', 'neuzin-core' ),
					'layout3' => esc_html__( 'Masonry layout 3', 'neuzin-core' ),
					'layout4' => esc_html__( 'Masonry layout 4', 'neuzin-core' ),
					'layout5' => esc_html__( 'Masonry layout 5', 'neuzin-core' ),
				),
				'default' => 'layout1',
			),
			...
			array (
				...
				'id'      => 'category_list',
				'label'   => esc_html__( 'Add as many Categories as you want', 'neuzin-core' ),
				'fields'  => array(
					array(
						'type'    => Controls_Manager::SELECT2,
						'name'    => 'cat_multi_box',
			...
			array(
				'type'    => Controls_Manager::SELECT2,
				'id'      => 'all_button',
				'label'   => esc_html__( 'Show All Button', 'neuzin-core' ),
				'options' => array(
					'show'        => esc_html__( 'Show', 'neuzin-core' ),
					'hide'        => esc_html__( 'Hide', 'neuzin-core' ),
				),
				'default' => 'show',
			),
			array(
