		...
		<ul class="animated-shape">
			...
			<li>
				<div class="translate-bottom-left-75 opacity-animation transition-200 transition-delay-10">
					<img width="574px" height="574px" loading="lazy" src="<?php echo NEUZIN_ASSETS_URL . 'element/element53.png' ?>" alt="Element">
				</div>
			</li>
			<li>
				<div class="translate-bottom-left-75 opacity-animation transition-200 transition-delay-300">
					<img width="472px" height="472px" loading="lazy" src="<?php echo NEUZIN_ASSETS_URL . 'element/element54.png' ?>" alt="Element">
				</div>
			</li>
		</ul>
	</div>
