...
$thumb_size = 'neuzin-size' . rand( 7, 8 ) ;
					...
					<a href="<?php the_permalink(); ?>">
						<?php
							if ( has_post_thumbnail() ){
								the_post_thumbnail( ('neuzin-size' . rand( 7, 8 ) ) , ['class' => 'img-fluid mb-10 width-100'] );
							} else {
								if ( !empty( NeuzinTheme::neuzin_options('no_preview_image')['id'] ) ) {
									echo wp_get_attachment_image( NeuzinTheme::neuzin_options('no_preview_image')['id'], ('neuzin-size' . rand( 7, 8 ) ) );
								} else {
