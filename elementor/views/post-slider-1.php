...
$neuzin_has_entry_meta1  = ( $data['post_grid_date'] == 'yes' || $data['post_grid_category'] == 'yes' ) ? true : false;
$neuzin_has_entry_meta2  = ( $data['post_grid_author'] == 'yes' || $data['post_grid_comment'] == 'yes' ) ? true : false;
			...
			<?php while ( $query->have_posts() ) : $query->the_post();?>
				...
				<div class="rtin-item">
					...
					<div class="rtin-content">
						...
						<?php if ( $neuzin_has_entry_meta2 ) { ?>
						<ul class="post-bottom-meta">
							<?php if ( $data['post_grid_author'] == 'yes' ) { ?>
							<li class="item-author"><i class="far fa-user"></i><?php esc_html_e( 'By ', 'neuzin-core' );?><?php the_author_posts_link(); ?></li>
							<?php } if ( $data['post_grid_comment'] == 'yes' ) { ?>
							<li><i class="far fa-comments"></i><a href="<?php echo get_comments_link( get_the_ID() ); ?>"><?php echo wp_kses_post( $neuzin_comments_html );?></a></li>
							<?php } ?>
						</ul>
						<?php } ?>
